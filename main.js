...
//funcion contraseña
 ...
 function validarConstraseña(e){
    ...
    e.nextElementSibling.innerHTML = patron.test(texto)
    if(!patron.test(texto)){
        document.getElementById("contraseña").innerHTML=" Introduce : Al menos 8 caracteres y una letra en mayúsculas, una minúscula y un digito "
        document.getElementById("contraseña").style.color="red"
    }else{
        document.getElementById("contraseña").innerHTML=" Usuario correcto"
 ...
 function validarEmail(e){
    ...
    e.nextElementSibling.innerHTML = patron.test(texto)
    if(!patron.test(texto)){
        document.getElementById("email").innerHTML=" Email y inconrrecto "
